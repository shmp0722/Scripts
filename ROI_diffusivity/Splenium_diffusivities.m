function  Splenium_diffusivities
...
cd('/biac4/wandell/biac3/wandell7/shumpei/matlab/git/LHON/Splenium_diffusivities');
...
boxplot([CRDmean.FA,LHONmean.FA,Ctlmean.FA]) 
