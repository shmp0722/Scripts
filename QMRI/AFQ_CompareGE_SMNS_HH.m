%% AFQ_CompareGE_SMNS_HH.m
% compare GE and Siemens DWI 
% set directories
...
% Diffusion
dtDir = {
    '/biac4/wandell/biac2/wandell/data/DWI-Tamagawa-Japan/JMD-Ctl-HH-20120907DWI/SMNS12dir_test/dwi'
    '/biac2/wandell2/data/WH/069_HH/DTI/dti96rt'};
...
afq.params.outdir = ...
    fullfile(saveDir);
afq.params.outname = 'AFQ_resurlts_Compare_HH1.mat';

% add additional maps to the structure.
t1Path{1} = HH_SMNS_T1w;
