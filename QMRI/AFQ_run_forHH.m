function [afq, patient_data, control_data, norms, abn, abnTracts] = AFQ_run_forHH(sub_dirs, sub_group, afq)
...
if AFQ_get(afq, 'use ANTS')
    % AFQ_ComputeSpatcailNormaliziion already done
    %     afq = AFQ_ComputeSpatialNormalization(afq);
    
    
    % So just set warp and invwarp
