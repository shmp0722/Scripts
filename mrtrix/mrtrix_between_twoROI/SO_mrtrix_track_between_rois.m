function fibersPDB = SO_mrtrix_track_between_rois
%
...
%% Set directory % JMD4(i = 4), HH(19), Ht(20) doesn't work
for i = 1:length(subjectDir);
    ...
    fibersFolder = fullfile(baseDir, subjectDir{i}, '/dwi_2nd/fibers/mrtrix/OR_center_peri');
    ...
    toRois   = {'rh_V1_smooth3mm_Center','lh_V1_smooth3mm_Center','rh_V1_smooth3mm_Peri','lh_V1_smooth3mm_Peri'};
    ...
    for k = 1:length(fromRois)
        ...
        wmMaskName      = fullfile(baseDir,  subjectDir{i}, '/dwi_2nd/ROIs',Hemi_wm);
