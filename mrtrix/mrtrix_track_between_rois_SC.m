function fibersPDB = mrtrix_track_between_rois_SC
%
...
subjectDir =  'JMD1-MM-20121025-DWI';
dtFile = fullfile(baseDir, subjectDir, '/dwi_2nd/dt6.mat');
refImg = fullfile(baseDir, subjectDir, '/t1.nii.gz');
fibersFolder = fullfile(baseDir, subjectDir, '/dwi_2nd/fibers/conTrack/OC_SC');

% We want to track the cortical pathway (LGN -> V1/V2 and V1/V2 -> MT)
fromRois = {'Optic-Chiasm'};
toRois   = {'Rt-SC_m'};
...
% seeding
wmMaskName      = fullfile(baseDir,  subjectDir, '/dwi_2nd/ROIs/Right-Cerebral-White-Matter_Rt-LGN4'); 
