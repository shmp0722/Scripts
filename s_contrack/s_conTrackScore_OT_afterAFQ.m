function s_conTrackScore_OT_afterAFQ(subjectnumber,thresh)
%%
...
for i =subjectnumber;
    ...
    Ids = {...
        '*_Rt-LGN4*_Ctrk100_AFQ*'
        '*_Lt-LGN4*_Ctrk100_AFQ*'};
    ...
    for ij = 1:length(Ids)
        ...
        for k = 1:length(thresh)
            ...
            outputfibername = fullfile(fibersFolder, sprintf('%s1018_Ctr%d.pdb', l{ij}, thresh(k)*100));
