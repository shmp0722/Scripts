...
%for subinds = 1:length(subnames)
    ...
    changedir = fullfile(homedir, subnames{subinds}, 'dwi_1nd','fibers','conTrack','TamagawaDWI2');
    %% Set the fullpath to data directory
    % /biac4/wandell/biac2/wandell/data/DWI-Tamagawa-Japan/JMD-Ctl-MT-20121025-DWI/dwi_1st/fibers/conTrack/TamagawaDWI2
...
%for subinds = 1:length(subnames)
    ...
    for ij = 1:length(Ids)
        ...
        % define how many fibers you want to reduce into%% s_conTrackPartNumPostMultiSS
% To save and score a particular number of pathways
%
