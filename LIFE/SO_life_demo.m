...
dwiFile       = fullfile('/biac4/wandell/biac2/wandell/data/DWI-Tamagawa-Japan/JMD1-MM-20121025-DWI/raw',...
    'dwi1st_aligned_trilin.nii.gz');
dwiFileRepeat = fullfile('/biac4/wandell/biac2/wandell/data/DWI-Tamagawa-Japan/JMD1-MM-20121025-DWI/raw',...
    'dwi2st_aligned_trilin.nii.gz');
t1File        = fullfile('/biac4/wandell/biac2/wandell/data/DWI-Tamagawa-Japan/JMD1-MM-20121025-DWI',...
    't1.nii.gz');
...
fgFileName    = fullfile('/biac4/wandell/biac2/wandell/data/DWI-Tamagawa-Japan/JMD1-MM-20121025-DWI/dwi_2nd/fibers/mrtrix2',...
                'dwi2nd_aligned_trilin_csd_lmax2_Rt-LGN4_rh_V1_smooth3mm_NOT_Rt-LGN4_rh_V1_smooth3mm_NOT_Right-Cerebral-White-Matter_Rt-LGN4_prob.pdb');
...
dprime     = se.s.mean;function [fh, fe] = life_demo()
%% Example of initialization and fitting of the LiFE model
% This demo function illustrates how to:
%  - A - Set up a LiFE structure, identified as 'fe' (fascicle evaluation) in
%  the code below. This model contains a prediction of the diffusion
