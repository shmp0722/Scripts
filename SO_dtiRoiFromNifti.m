function roi = SO_dtiRoiFromNifti(nifti,maskValue,outName,outType,binary,save)
% 
...
if ischar(nifti);
    nifti = niftiRead(nifti);
elseif isstruct(nifti);
    
elseif notDefined('nifti') || ~exist(nifti,'file')
    nifti = mrvSelectFile('r','*.nii*','Select nifti',pwd);
