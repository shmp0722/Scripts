...
%     
    ...
    roi3 =fullfile(RoiDir,'Left-Cerebral-Cortex.mat');
    roi4 =fullfile(RoiDir,'Right-Cerebral-Cortex.mat');
...
%     end
    ...
    %% Clip L-OR
    % Define the cutpoit using Lateral Ventricle 
    % most posteror poin
