function Plot_Tractprofiles_3RP
%% R_OR indivisual
...
load 4JMD_5CRD_6LHON_8Ctl_3RP_1208.mat
% 
%% all 
...
% Ctl.rd = nansum(afq.vals.rd{21}(16:23,:),1)/8;
% % se
...
figure; hold on;
boxplot([JMD_ROR',CRD_ROR',LHON_ROR',RP_ROR',Ctl_ROR'],'notch','on')
...
% saveas(gcf,'ROR_FA_4groups', 'eps')

print(gcf, '-depsc', '-noui', sprintf('ROR_%s_5groups_box.eps',diffusivity))
%% L-OR
boxplot([JMD_LOR',CRD_LOR',LHON_LOR',RP_LOR',Ctl_LOR'],'notch','on')
...
print(gcf, '-depsc', '-noui', sprintf('LOR_%s_4groups_boxs.eps',diffusivity))

%% ROT
boxplot([JMD_ROT,CRD_ROT,LHON_ROT,RP_ROT',Ctl_ROT],'notch','on')
...
print(gcf, '-depsc', '-noui', sprintf('ROT_%s_4groups_box.eps',diffusivity))
...
print(gcf, '-depsc', '-noui', sprintf('LOT_%s_4groups_box.eps',diffusivity))
...
%% save the figure in .eps
print(gcf, '-depsc', '-noui', sprintf('OCF_%s_4groups_box.eps',diffusivity))
