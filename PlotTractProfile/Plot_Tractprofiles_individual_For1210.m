function Plot_Tractprofiles_individual_For1210
%% R_OR indivisual
...
for ii =1:4
    ...
    % tract =
    boxplot(ROR','notch','on');
    % ,'labels',...
    %     {'CMD1','CMD2','CMD3','CMD4',...
    %     'CRD1','CRD2','CRD3','CRD4','CRD5',...
    %     'LHON1','LHON2','LHON3','LHON4','LHON5','LHON6',...
    %     'Ctl1','Ctl2','Ctl3','Ctl4','Ctl5','Ctl6','Ctl7','Ctl8',...
    %     'RP1','RP2','RP3'});
    
    %     'labels',{'JMD', 'OCF_R','LHON', 'RP','Ctl'},'notch','on');
    ...
    %     case 'png'
    print(gcf, '-dpng', '-noui', sprintf('ROR_%s_individual_box.png',diffusivity))
    % end
    close all;
    ...
    %     case 'png'
    print(gcf, '-dpng', '-noui', sprintf('LOR_%s_individual_box.png',diffusivity))
    % end
    close all;
    
    %% ROT
    boxplot(ROT','notch','on');
    ...
    %     case 'png'
    print(gcf, '-dpng', '-noui', sprintf('ROT_%s_individual_box.png',diffusivity))
    % end
    close all;
    
    %% LOT
    boxplot(LOT','notch','on');
    ...
    boxplot(OCF_L','notch','on');
    
    % legend('JMD', 'LHON', 'Ctl');
    xlabel('Groups','fontName','Times','fontSize',14);
    ylabel('Fractional Anisotropy','fontName','Times','fontSize',14);
    title('OCF_L','fontName','Times','fontSize',14);
    hold off;
    ...
    boxplot(OCF_R','notch','on');
    
    % legend('JMD', 'LHON', 'Ctl');
    xlabel('Groups','fontName','Times','fontSize',14);
    ylabel('Fractional Anisotropy','fontName','Times','fontSize',14);
    title('OCF_R','fontName','Times','fontSize',14);
    hold off;
    ...
    %     case 'png'
    print(gcf, '-dpng', '-noui', sprintf('OCF_R_%s_individual_box.png',diffusivity))
    % end
    close all;
end
return
