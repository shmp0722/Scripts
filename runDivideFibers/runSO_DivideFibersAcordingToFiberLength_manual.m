function [TractProfile, fg_SDm4,fg_SDm3,fg_SDm2,fg_SDm1,fg_SD1,fg_SD2,fg_SD3,fg_SD4] = ...
    runSO_DivideFibersAcordingToFiberLength_manual
...
for i =1%[1:18,20,21,23]%:length(subDir)
    % define dire
...
cd /biac4/wandell/biac2/wandell/data/DWI-Tamagawa-Japan/JMD1-MM-20121025-DWI/dwi_2nd/FiberLength/LOR1206_D4L4

    
%     fgF = {'/biac4/wandell/biac2/wandell/data/DWI-Tamagawa-Japan/JMD1-MM-20121025-DWI/dwi_2nd/fibers/conTrack/OR_1130/LOR_1201.pdb',...
%         '/biac4/wandell/biac2/wandell/data/DWI-Tamagawa-Japan/JMD1-MM-20121025-DWI/dwi_2nd/fibers/mrtrix2/dwi2nd_aligned_trilin_csd_lmax2_Rt-LGN4_rh_V1_smooth3mm_NOT_Rt-LGN4_rh_V1_smooth3mm_NOT_Right-Cerebral-White-Matter_Rt-LGN4_prob_MD4.pdb'};
    
    fgF ={'/biac4/wandell/biac2/wandell/data/DWI-Tamagawa-Japan/JMD1-MM-20121025-DWI/dwi_2nd/FiberLength/LOR1206_D4L4/LOR_C.pdb',...
        '/biac4/wandell/biac2/wandell/data/DWI-Tamagawa-Japan/JMD1-MM-20121025-DWI/dwi_2nd/FiberLength/LOR1206_D4L4/LOR_D.pdb',...
        '/biac4/wandell/biac2/wandell/data/DWI-Tamagawa-Japan/JMD1-MM-20121025-DWI/dwi_2nd/FiberLength/LOR1206_D4L4/LOR_V.pdb'};
%     fgF{1} = mtrImportFibers(fgf{1});    fgF{2} = mtrImportFibers(fgf{2});     fgF{3} = mtrImportFibers(fgf{3});
...
% fg = mtrImportFibers(fgFile)
    ...
    [TractProfile{i,j}, fg_SDm4{i,j},fg_SDm3{i,j},fg_SDm2{i,j},fg_SDm1{i,j},fg_SD1{i,j},fg_SD2{i,j},fg_SD3{i,j},fg_SD4{i,j}]...
        = SO_DivideFibersAcordingToFiberLength(fgF{j},dt,1,'AP',100);
    end
end
save JMD_1_LOR_Manual TractProfile
return
